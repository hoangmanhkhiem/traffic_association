...
<!-- Event Image -->
<?php if (!empty(tribe_event_featured_image( null, 'cmsmasters-blog-masonry-thumb' ))) {
	echo '<div class="cmsmasters_tribe_img_date">'
			. tribe_event_featured_image( null, 'cmsmasters-blog-masonry-thumb' ) .
		'<div class="cmsmasters_tribe_events_date">
			<span class="cmsmasters_tribe_events_date_month">'. tribe_get_start_date(null, false, 'M') .'</span>
			<span class="cmsmasters_tribe_events_date_day">'. tribe_get_start_date(null, false, 'd') .'</span>	
		</div>
	</div>';
} ?>
