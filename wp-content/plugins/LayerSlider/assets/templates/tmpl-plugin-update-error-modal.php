...
<script type="text/html" id="tmpl-plugin-update-error-modal">
	<div id="ls-plugin-update-error-modal">
		...
		<p><?= sprintf(__('Additionally, you should check %sSystem Status%s to uncover potential issues affecting your site.', 'LayerSlider'), '<a href="'.admin_url( 'admin.php?page=layerslider&section=system-status' ).'" target="_blank">', '</a>') ?></p>
